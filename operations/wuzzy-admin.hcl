...
job "wuzzy-admin" {
  ...
  group "wuzzy-admin-group" {
    ...
    task "wuzzy-admin-api-task" {
      ...
      config {
        image = "ghcr.io/memetic-block/wuzzy-backend:sha-4fc0f219a070056f417f1e8089028ed4fcb5ca5f"
        ports = ["api"]
      }
    ...
    task "wuzzy-admin-web-task" {
      ...
      config {
        image = "ghcr.io/memetic-block/wuzzy-admin:sha-4fc0f219a070056f417f1e8089028ed4fcb5ca5f"
        ports = ["http"]
      }
